...
export function UpdateClassroom() {
  ...
  const fetchAttendances = async () => {
    ...
    if (res) setAttendances(res.studentsAttendances.map((c, i) => ({ ...c, stt: i + 1 })));
  };
        ...
        <Row gutter={32}>
          <Col span={8}>
            <Form.Item label="Khóa học" name="course">
              <Select placeholder="Khóa học" onChange={onChangeCourse} disabled>
          ...
          <Col span={8}>
            <Form.Item label="Cơ sở" name="location">
              <Select placeholder="Cơ sở" onChange={onChangeFacility} disabled>

        ...
        <div className="contents3">
          <Card
            ...
            cover={
              <Link to="/detail">
                <img
                  alt="example"
                  src="https://e1.pxfuel.com/desktop-wallpaper/514/124/desktop-wallpaper-2048x2048-python-logo-ipad-air-backgrounds-and-python-code.jpg"
                />
              </Link>
            }
          >
          ...
          <Card
            ...
            cover={
              <img
                alt="example"
                src="https://stitcher.imgix.net/d0306685ac66e9612a315182b01f834a0c605361e271267595a34eeda86cb85c?w=850&h=850&sat=-100"
              />
            }
          >
          ...
          <Card
            ...
            cover={
              <img
                alt="example"
                src="https://e1.pxfuel.com/desktop-wallpaper/796/952/desktop-wallpaper-disc-c-programming-language.jpg"
              />
            }
          >
        ...
        <div className="contents3">
          <Card
            ...
            cover={
              <img
                alt="example"
                src="https://stitcher.imgix.net/66a8a497f71e8e7fb5c4b715346459ce87fb736e5e8dc04351b9538bc0613622?w=850&h=850&sat=-100"
              />
            }
          >
          ...
          <Card
            ...
            cover={
              <img
                alt="example"
                src="https://e1.pxfuel.com/desktop-wallpaper/439/889/desktop-wallpaper-c-c-plus-plus.jpg"
              />
            }
          >
          ...
          <Card
            ...
            cover={
              <img
                alt="example"
                src="https://e0.pxfuel.com/wallpapers/907/48/desktop-wallpaper-sl-5-4-and-black-friday-smartlauncher-kotlin.jpg"
              />
            }
          >
            <Meta
              title="Kotlin "
              description="5.100.000 VNĐ - 111 lượt đăng ký"
            />
          </Card>
        </div>
        <div className="contents3">
          <Card
            ...
            cover={
              <img
                alt="example"
                src="https://apollo-singapore.akamaized.net/v1/files/cst94eb4fu3c1-IN/image;s=850x0"
              />
            }
          >
          ...
          <Card
            ...
            cover={
              <img
                alt="example"
                src="https://e0.pxfuel.com/wallpapers/811/90/desktop-wallpaper-typescript.jpg"
              />
            }
          >
            <Meta
              title="TypeScript"
              description="3.600.000 VNĐ - 312 lượt đăng ký"
            />
          </Card>
          <Card
            className="card5"
            ...
            cover={
              <img
                alt="example"
                src="https://e0.pxfuel.com/wallpapers/160/491/desktop-wallpaper-ruby-gem-png-ruby-gemstone.jpg"
              />
            }
          >
